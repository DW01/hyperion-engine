...
{
    public partial class AddNewSceneDialog : Window
    {
        public AddNewSceneDialogViewModel ViewModel => (AddNewSceneDialogViewModel)DataContext!;
        ...
        public AddNewSceneDialog()
        {
            ...
            Title = "Add New Scene";
            DataContext = new AddNewSceneDialogViewModel();
        }
