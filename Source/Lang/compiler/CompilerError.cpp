...
const HashMap<ErrorMessage, String> CompilerError::errorMessageStrings {
    ...
    { Msg_extern_cannot_have_assignment, "An extern variable or function cannot have an assignment" },
    ...
    { Msg_expression_not_generic, "Generic arguments provided to non-generic expression of type '%'" },
    ...
    { Msg_mismatched_types_assignment_more_info, "Cannot assign % to %.%" },
    ...
    { Msg_missing_argument, "Missing argument: '%'" },
    ...
    { Msg_instance_member_not_found, "'%' not found in %" },
